...
class Service(models.Model):
    ...
    tags = models.TextField('Теги через запятую', blank=True, null=True)
    ...
    heading_3 = models.CharField("Заголовок 3", max_length=255, blank=True)
    text_3 = models.TextField("Текст 3", blank=True)
    heading_4 = models.CharField("Заголовок 4", max_length=255, blank=True)
    text_4 = models.TextField("Текст 4", blank=True)
